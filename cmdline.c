...
/* *** SHOW STREAM STATS ALL*** */
struct cmd_showstreamall_result {
	cmdline_fixed_string_t show;
	cmdline_fixed_string_t stream;
	cmdline_fixed_string_t what;
	cmdline_fixed_string_t all;
};
static void cmd_showstreamall_parse(void *parsed_result,
				__rte_unused struct cmdline *cl,
				__rte_unused void *data)
{
	struct cmd_showstreamall_result* res=parsed_result;
	if(strcmp(res->show,"clear")){
		clear_stream_stats_all();
	}else{
		show_stream_stats_all();
	}
}


cmdline_parse_token_string_t cmd_showstreamall_show =
	TOKEN_STRING_INITIALIZER(struct cmd_showstreamall_result, show,
				 "show#clear");
cmdline_parse_token_string_t cmd_showstreamall_stream =
	TOKEN_STRING_INITIALIZER(struct cmd_showstreamall_result, stream, "stream");
cmdline_parse_token_string_t cmd_showstreamall_what =
	TOKEN_STRING_INITIALIZER(struct cmd_showstreamall_result, what,
				 "stats");
cmdline_parse_token_string_t cmd_showstreamall_all =
	TOKEN_STRING_INITIALIZER(struct cmd_showstreamall_result, all, "all");

cmdline_parse_inst_t cmd_showstreamall = {
	.f = cmd_showstreamall_parse,
	.data = NULL,
	.help_str = "show|clear stream "
		"stats"
		"all|<stream_id>",
	.tokens = {
		(void *)&cmd_showstreamall_show,
		(void *)&cmd_showstreamall_stream,
		(void *)&cmd_showstreamall_what,
		(void *)&cmd_showstreamall_all,
		NULL,
	},
};

/* *** SHOW STREAM STATS NUM*** */
struct cmd_showstream_result {
	cmdline_fixed_string_t show;
	cmdline_fixed_string_t stream;
	cmdline_fixed_string_t what;
	uint16_t num;
};
static void cmd_showstream_parse(void *parsed_result,
				__rte_unused struct cmdline *cl,
				__rte_unused void *data)
{
	struct cmd_showstream_result* res=parsed_result;
	if(strcmp(res->show,"clear")){
		clear_stream_stats(res->num);
	}else{
		show_stream_stats(res->num);
	}
}


cmdline_parse_token_string_t cmd_showstream_show =
	TOKEN_STRING_INITIALIZER(struct cmd_showstream_result, show,
				 "show#clear");
cmdline_parse_token_string_t cmd_showstream_stream =
	TOKEN_STRING_INITIALIZER(struct cmd_showstream_result, stream, "stream");
cmdline_parse_token_string_t cmd_showstream_what =
	TOKEN_STRING_INITIALIZER(struct cmd_showstream_result, what,
				 "stats");
cmdline_parse_token_num_t cmd_showstream_num =
	TOKEN_NUM_INITIALIZER(struct cmd_showstream_result, num, RTE_UINT16);

cmdline_parse_inst_t cmd_showstream = {
	.f = cmd_showstream_parse,
	.data = NULL,
	.help_str = "show|clear stream "
		"stats"
		"all|<stream_id>",
	.tokens = {
		(void *)&cmd_showstream_show,
		(void *)&cmd_showstream_stream,
		(void *)&cmd_showstream_what,
		(void *)&cmd_showstream_num,
		NULL,
	},
};
